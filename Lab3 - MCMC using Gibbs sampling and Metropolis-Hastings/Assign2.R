...
##  a)
data.ebay <- read.table("/Users/davidgumpert/Desktop/TDDE07/Labs/Lab3 - MCMC using Gibbs sampling and Metropolis-Hastings/eBayNumberOfBidderData.txt", header = TRUE)
